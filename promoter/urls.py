...
from promoter.views import update_promoter, reset_password, signup_view_promoter, signin_view_promoter, \
    ...
    balance_history_payout, payout_pdf_view, webhook_payout, bank_information_connect, bank_information_connect_webhook
...
urlpatterns = [
    ...
    # payout
    path('payout/bank/information/webhook/', bank_information_connect_webhook, name='bank_information_connect_webhook'),
    path('payout/bank/information/', bank_information_connect, name='bank_information_connect'),
