...
class SignUpFormPromoter(forms.Form):
    ...
    social_security = forms.CharField(max_length=12, help_text='Social security information is used for taxes purposes. Your information will not be shared with any company.')
